const translations = {
    en: {
        ...
        aboutText3: "Our site is non-commercial and belongs to every Azerbaijani. We invite our compatriots from Western Azerbaijan to cooperate regarding any unnoticed place names and potential gaps on the map.",
    ...
    az: {
        ...
        aboutText3: "Saytmız qeyri-kommersiya xarakterli olaraq hər bir Azərbaycanlıya məxsusdur. Biz diqqətdən yayınan toponimlərimizin yerləşdirilməsi və xəritədə ola biləcək hər hansı bir çatışmamazlıqla əlaqədar Qərbi Azərbaycandan olan soydaşlarımızı əməkdaşlığa dəvət edirik.",
        aboutText4: "44 günlük Vətən müharibəsində qazandığımız zəfərdən və 23 saatlıq uğurlu anti-terror əməliyyatından sonra Qarabağımıza qovuşduğumuz kimi Qərbi Azərbaycanımıza da qovuşmağımızın bir addımlığındayıq. Təqdim etdiyimiz bu virtual xəritə dədə baba torpaqlarımızdan didərgin düşən deportasiyaya uğrayan böyük faciələr yaşayan soydaşlarımız üçün onların qayıdışın işıq saça bilər.",
